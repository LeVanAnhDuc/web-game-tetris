...
| --- | --- | --- | --- | --- |
| <!-- ví dụ --> Task | Một việc cần làm, có người phụ trách và hạn | `Task` | Công việc | Task |
| <!-- TODO --> | | | | |

**Tên bị cấm:** <!-- TODO: những từ đồng nghĩa đã loại, để không ai dùng lại. Ví dụ: dùng `Task`, không dùng `Todo`/`Item`/`Job`. -->
